...
func (s *Server) setupRoutes() {
	...
	openaiV1.Use(AuthMiddleware(s.accessManager))
	{
		...
		openaiV1.POST("/images/generations", openaiHandlers.ImagesGenerations)
		openaiV1.POST("/images/edits", openaiHandlers.ImagesEdits)
		openaiV1.POST("/embeddings", openaiHandlers.Completions)
		openaiV1.GET("/responses", openaiResponsesHandlers.ResponsesWebsocket)
		openaiV1.POST("/responses", openaiResponsesHandlers.Responses)
		openaiV1.POST("/responses/compact", openaiResponsesHandlers.Compact)
